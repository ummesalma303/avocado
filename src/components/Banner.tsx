  ...
  <Swiper
      ...
      >
       {/* <Slider/> */}
        ...
        <SwiperSlide>
        <Slider img={"https://img.freepik.com/free-photo/healthy-balanced-vegetarian-food-top-view_1150-37017.jpg"} justify={'end'} text={"Our Garden's Most Favorite Food"}/>
        </SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
        <Slider img={"https://static.vecteezy.com/system/resources/previews/031/988/708/non_2x/organic-food-big-assortment-of-healthy-fruits-and-vegetables-photo.jpg"} justify={'end'} text={"Our Garden's Most Favorite Food"}/>
        </SwiperSlide>
