    ...
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
         ...
         <Image src='/assets/icon-3.png' width={60} height={60} alt='avocado' />
         <h2 className='text-2xl font-bold'>Avocado</h2>
      </div>
            <p className=" text-gray-500">
            Discover our most loved dishes-flavorful, fresh, and always a customer favorite every single day.
            </p>
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            >
              ...
              <Link href='/sign-up'><Button className="mt-1 w-full bg-black px-6 py-5 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-green-600 sm:mt-0 sm:w-auto sm:shrink-0 rounded-none">Sign Up</Button></Link>
            </div>
          </form>
        </div>
